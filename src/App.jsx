...
import { mockEvents, mockCommunityStats } from "./data";
...
function HomePage() {
  ...
  // Load businesses from service on component mount
  React.useEffect(() => {
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Our foundation is built on five essential pillars that strengthen
              our community and ensure our collective success and independence.
            </p>
          </div>
            ...
            {[
              {
                ...
                title: "Unity",
                description:
                  "A scattered community is easily broken. We put aside divisions and recognize our shared destiny to stand strong against external pressures.",
                color: colors.red,
              },
              {
                icon: TrendingUp,
                ...
                description:
                  "Support Black-owned businesses, keep money circulating within our community, and own land to ensure our future is not controlled by others.",
                color: colors.green,
              },
              {
                icon: Target,
                ...
                description:
                  "Learn essential, practical skills like farming, trades, security, and first aid - necessities for survival when established systems collapse.",
                color: colors.gold,
              },
              {
                icon: Shield,
                title: "Protection",
                description:
                  "We cannot rely on external forces for safety. We must train, organize, and watch over our own neighborhoods to protect our people from harm.",
                color: colors.black,
              },
              {
                icon: Mic,
                ...
                description:
                  "Build and support media that portrays our community with dignity and strength, preventing outsiders from twisting our story to justify oppression.",
                color: colors.red,
              },
            ].map((pillar, index) => (
              <Card key={index} className="hover:shadow-lg transition-shadow">
                <CardHeader>
                  <div className="flex items-center mb-4">
                    ...
                    <CardTitle style={{ color: colors.black }}>
                      {pillar.title}
                    </CardTitle>
                  </div>
                </CardHeader>
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600">
              Join us for educational webinars, networking events, and community
              building activities
            </p>
          </div>
      ...
      <section className="py-16 bg-red-600 text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl mb-8 opacity-90">
            Get the latest updates on community events, business opportunities,
    ...
    <div className="min-h-screen py-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600">
            Empower yourself with knowledge and skills for community building
            and economic growth
          </p>
        </div>
    ...
    <div className="min-h-screen py-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600">
            Stay informed with community news, success stories, and empowering
            content
          </p>
        </div>
        <div className="text-center py-12">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid md:grid-cols-4 gap-8">
          <div>
            <div className="flex items-center mb-4">
              <img
                src={logoMain}
                alt="Unity Collective"
                className="h-8 w-8 mr-2"
              />
              <span className="text-xl font-bold">Unity Collective</span>
            </div>
            <p className="text-gray-400 mb-4">
              Empowering the Black community through unity and economic
              strength.
            </p>
          </div>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 text-center">
          <p className="text-gray-400">
            © 2025 Unity Collective. All rights reserved. Built with pride for
            our community.
          </p>
        </div>
      </div>
