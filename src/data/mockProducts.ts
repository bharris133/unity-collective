...
export const mockProducts: Product[] = [
  {
    ...
    price: 2499,
    category: 'Apparel',
    images: ['https://placehold.co/300x300/e5e5e5/666666?text=Product+Image'],
    inStock: true,
    stockQuantity: 50,
  ...
  {
    productId: 'afro-art-print-001',
    vendorId: 'afrocentric-books',
  ...
  {
    productId: 'wellness-oil-001',
    vendorId: 'wellness-imani',
    name: 'Essential Oil Blend Set',
    description: 'Curated set of essential oils for relaxation, focus, and energy.',
    price: 3999,
  ...
  {
    productId: 'academy-workbook-001',
    vendorId: 'black-excellence-academy',
  ...
  {
    productId: 'crown-hair-oil-001',
    vendorId: 'crown-glory',
  ...
  {
    productId: 'soul-food-cookbook-001',
    vendorId: 'soul-food-kitchen',
  ...
  {
    productId: 'urban-threads-jacket-001',
    vendorId: 'urban-threads',
  ...
  {
    productId: 'heritage-hot-sauce-001',
    vendorId: 'heritage-foods',
  ...
  {
    productId: 'wellness-yoga-mat-001',
    vendorId: 'wellness-imani',
  ...
  {
    productId: 'tech-consultation-001',
    vendorId: 'unity-tech',
